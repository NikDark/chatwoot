Rails.application.routes.draw do
  ...
  if ActiveModel::Type::Boolean.new.cast(ENV.fetch('CW_API_ONLY_SERVER', false))
    ...
    get '/app/accounts/:account_id/settings/inboxes/:inbox_id/finish', to: 'dashboard#index', as: 'app_inbox_finish'
  ...
  post 'webhooks/max/:bot_token', to: 'webhooks/max#process_payload'
